...
export default function Toolkit() {
    ...
    return (
        <section className="w-full max-w-6xl mx-auto px-6 py-24">
            {/* Header parfaitement aligné sur le reste du portfolio */}
            ...
            {/* Grille épurée sans barres de progression */}
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                {tools.map((tool, index) => (
                    ...
                    >
                        {/* Effet de glow discret au survol */}
                        ...
                        <div className="relative z-10 flex flex-col items-center text-center">
                            ...
                            <div className="mb-6 h-12 w-12 flex items-center justify-center grayscale group-hover:grayscale-0 transition-all duration-500 transform group-hover:scale-110">
                                <img
                                    src={tool.logo}
                                    alt={`${tool.name} logo`}
                        ...
                        {/* Décoration style terminal en bas de carte */}
