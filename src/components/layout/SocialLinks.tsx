    ...
    return (
        ...
        <div className="flex items-center gap-6">
            ...
            <motion.div
                ...
                className="w-px bg-white/10 ml-2 hidden md:block"
            />
        </div>
    );
}